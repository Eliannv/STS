// facturacion-servicio/src/app.js
...
import { workerOperacionesPendientes } from './infraestructura/contenedor/FacturaContenedor.js';
...
sequelize.authenticate()
  .then(() => app.listen(port, () => {
    workerOperacionesPendientes.start();
    console.log(`facturacion-servicio escuchando en ${port}`);
  }))
  .catch((error) => {
    console.error('No se pudo iniciar facturacion-servicio:', error.message);
    process.exit(1);
  });
