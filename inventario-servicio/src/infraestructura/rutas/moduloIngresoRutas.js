...
router.get('/buscar/:id', authMiddleware(), guardaSucursal(), (req, res) => ingresoControlador.buscarPorId(req, res));
...
router.get('/:id', authMiddleware(), guardaSucursal(), (req, res) => ingresoControlador.buscarPorId(req, res));
