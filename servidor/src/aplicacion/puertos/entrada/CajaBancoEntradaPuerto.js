// src/aplicacion/puertos/entrada/CajaBancoEntradaPuerto.js
export default class CajaBancoEntradaPuerto {
  ...
  cajaAbierta(req, res)         { throw new Error('cajaAbierta no implementado') }
  registrarMovimiento(req, res) { throw new Error('registrarMovimiento no implementado') }
  listarMovimientos(req, res)   { throw new Error('listarMovimientos no implementado') }
  eliminarMovimiento(req, res)  { throw new Error('eliminarMovimiento no implementado') }
}
