...
// Caja Banco es central: pertenece a la empresa, no a una sucursal.
const guardaBanco = guardaSucursal({ permitirGlobal: true });
import {
...
router.get('/cajas-banco/buscar/:id', authMiddleware(), guardaBanco, (req, res) => cajaBancoControlador.buscarPorId(req, res));
...
router.get('/cajas-banco/:id/movimientos', authMiddleware(), guardaBanco, (req, res) => cajaBancoControlador.listarMovimientos(req, res));
router.get('/cajas-banco/:id', authMiddleware(), guardaBanco, (req, res) => cajaBancoControlador.buscarPorId(req, res));
...
router.get('/cajas-chicas/buscar/:id', authMiddleware(), guardaSucursal(), (req, res) => cajaChicaControlador.buscarPorId(req, res));
...
router.get('/cajas-chicas/:id/movimientos', authMiddleware(), guardaSucursal({ resolverPadre: sucursalDeCajaChica }), (req, res) => cajaChicaControlador.listarMovimientos(req, res));
router.get('/cajas-chicas/:id', authMiddleware(), guardaSucursal(), (req, res) => cajaChicaControlador.buscarPorId(req, res));
