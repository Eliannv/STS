...
export default function VerCajaBanco() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 100, flexDirection: 'column', gap: 12 }}>
      ...
      <span style={{ color: 'var(--text-muted)', fontSize: 14 }}>Cargando caja banco...</span>
    </div>
  );
  ...
  // Resumen por categoría (solo egresos/ingresos)
  ...
  return (
    <div className="page">
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 24 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
            <h1 style={{ fontSize: 22, fontWeight: 700, margin: 0 }}>Caja Banco — {FECHA(caja.fecha)}</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(155px, 1fr))', gap: 12, marginBottom: 20 }}>
        <KpiCard label="Saldo inicial"  value={FMT(caja.saldo_inicial)}         color="#3498db" />
        ...
        <KpiCard label="Saldo actual"   value={FMT(caja.saldo_actual)}
          color={parseFloat(caja.saldo_actual) > 0 ? '#28a745' : '#dc3545'}
      ...
      <div style={{ background: '#fff', border: '1px solid #e9ecef', borderRadius: 10, overflow: 'hidden' }}>
        <div style={{ padding: '14px 20px', borderBottom: '1px solid #e9ecef', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
          ...
          <input type="text" placeholder="Buscar por descripción, referencia o categoría..."
            ...
            style={{ padding: '7px 12px', border: '1px solid var(--border-color)', borderRadius: 7, fontSize: 13, width: 310 }} />
        </div>
            ...
            <tbody>
              {movsFiltrados.length === 0 ? (
                ...
                <tr key={m.id} style={{ borderBottom: '1px solid #f0f0f0' }}>
                  ...
                  <td style={{ padding: '10px 14px' }}>
                    <span style={{ background: '#e9ecef', color: '#495057', padding: '2px 8px', borderRadius: 99, fontSize: 11, fontWeight: 600, whiteSpace: 'nowrap' }}>
