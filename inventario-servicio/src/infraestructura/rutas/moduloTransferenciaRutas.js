...
import { exigirSucursal, guardaSucursal } from '../middleware/SucursalScopeMiddleware.js';
import { sucursalDeTransferencia } from '../middleware/resolversSucursal.js';
...
router.get('/:id', authMiddleware(), guardaSucursal({ resolverPadre: sucursalDeTransferencia }), (req, res) => transferenciaControlador.buscarPorId(req, res));
